...
from exp.exp_classification import Exp_Classification  # 添加分类实验类
import random
import numpy as np
import os
...
# classification task specific parameters
...
if args.is_training:
    for ii in range(args.itr):
        ...
        if args.task_name == 'classification':
            setting = '{}_{}_{}_{}_{}_sl{}_dm{}_el{}_dl{}_df{}_nc{}_{}_{}'.format(
                args.task_name,
                args.model_id,
                args.comment,
                args.model,
